...
sig { params(drink_list: T::Array[String]).returns(T::Boolean) }
...
sig { params(guess_list: T::Array[Integer], answer: Integer).returns(T::Boolean) }
def correct_guess?(guess_list, answer)
  # use #any? to return true when any element of the guess_list (array) equals the answer (number)
  guess_list.any?(answer)
end

sig { params(year_list: T::Array[String]).returns(T::Boolean) }
...
sig { params(word_list: T::Array[String]).returns(T::Boolean) }
...
sig { params(score_list: T::Hash[Symbol, Integer], perfect_score: Integer).returns(T::Boolean) }
