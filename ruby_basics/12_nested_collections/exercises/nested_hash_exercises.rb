...
sig { params(languages: T::Hash[Symbol, T::Hash[Symbol, T.any(String, T::Boolean)]], language_name: Symbol).returns(T.untyped) }
...
sig { params(languages: T::Hash[Symbol, T::Hash[Symbol, T.any(String, T::Boolean)]], language_name: Symbol, info_key: Symbol, info_value: T.any(String, T::Boolean)).returns(T::Hash[Symbol, T::Hash[Symbol, T.any(String, T::Boolean)]]) }
def add_information_about_language(languages, language_name, info_key, info_value)
  ...
  T.must(languages[language_name])[info_key] = info_value
  languages
end

sig { params(languages: T::Hash[Symbol, T::Hash[Symbol, T.any(String, T::Boolean)]], language_name: Symbol, language_info_value: T::Hash[Symbol, T.any(String, T::Boolean)]).returns(T::Hash[Symbol, T::Hash[Symbol, T.any(String, T::Boolean)]]) }
...
sig { params(languages: T::Hash[Symbol, T::Hash[Symbol, T.any(String, T::Boolean)]], language_name: Symbol, info_key: Symbol).returns(T::Hash[Symbol, T::Hash[Symbol, T.any(String, T::Boolean)]]) }
def delete_information_about_language(languages, language_name, info_key)
  ...
  T.must(languages[language_name]).delete(info_key)
  languages
end

sig { params(languages: T::Hash[Symbol, T::Hash[Symbol, T.any(String, T::Boolean)]], language_name: Symbol).returns(T::Hash[Symbol, T::Hash[Symbol, T.any(String, T::Boolean)]]) }
...
sig { params(languages: T::Hash[Symbol, T::Hash[Symbol, T.any(String, T::Boolean)]]).returns(T::Hash[Symbol, T::Hash[Symbol, T.any(String, T::Boolean)]]) }
def find_beautiful_languages(languages)
  ...
  languages.select do |lang, data|
    data[:is_beautiful?] == true
  end
end

sig { params(languages: T::Hash[Symbol, T::Hash[Symbol, T.untyped]], language_name: T.untyped, fact_index: T.untyped).returns(T.untyped) }
